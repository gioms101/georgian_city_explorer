...
class TravelMap:
    ...
    def create_journey_map(self, city, places):
        response = self.client.beta.chat.completions.parse(
            ...
            messages=[
                {"role": "system",
                 "content": f"You should create Traveler Map of the city which user prompts. This is places {places} Where from you should make Traveler Map. You should tell few information about each places to user."},
